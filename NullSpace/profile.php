...
<p><div id="SkypeButton_Call_Sujay_1">
      ...
      "imageSize": 32
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <ul class="progess-bars">
                                            <li>
                                                <div class="progress">
                                                    <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"> Course Overview 60%</div>
                                                </div>
                                            </li>
                                            <li>
